      ...
      def self.build_all
        ...
        [
          # ── Perception ────────────────────────────────────────────────────
          {
            ...
            description:
              "Look at the current room or at a specific target. This gameplay " \
              "action automatically connects and logs in if disconnected. Call with NO " \
          ...
          },
          {
            ...
            description: "Report whether the MUD session is currently connected. " \
                         "This check does not connect. If disconnected, call any gameplay " \
                         "tool such as look; gameplay tools connect and log in automatically.",
            params: {}
          }
        ]
      end
