  ...
  module Backends
    class Anthropic < Base
      ...
      def to_payload(context, max_output_tokens: 1024, tools: nil)
        ...
        # The current Anthropic Messages API accepts the top-level system
        # prompt as an array of content blocks. Sending a bare string now
        # produces: "system: Input should be a valid array".
