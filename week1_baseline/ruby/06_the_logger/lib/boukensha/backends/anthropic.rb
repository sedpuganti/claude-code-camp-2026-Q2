  ...
  module Backends
    class Anthropic < Base
      ...
      def to_payload(context, max_output_tokens: 1024, tools: nil)
        {
          model: @model,
          # Recent Anthropic API versions require the system prompt in the
          # content-block form rather than as a scalar string.
          system: [{ type: "text", text: context.system.to_s }],
